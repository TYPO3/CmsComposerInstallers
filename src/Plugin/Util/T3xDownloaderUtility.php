...
class T3xDownloaderUtility
{
    ...
    public static function extract($file, $path)
    {
        ...
        self::writeEmConf($extensionData, $path);
    }
    ...
    public static function getLocalChanges(PackageInterface $package, $path)
    {
        ...
        try {
            $emMetaData = self::getEmConfMetaData($path);
     ...
     * @return array mixed
     */
    public static function getEmConfMetaData($path)
    {
     ...
     */
    public static function writeEmConf(array $extensionData, $path)
    {
        $emConfFileData = [];
        if (file_exists($path . 'ext_emconf.php')) {
            $emConfFileData = self::getEmConfMetaData($path);
        }
...
?>';
     ...
     * @return array
     */
    public static function convertDependencies($dependencies)
    {
        $newDependencies = [];
